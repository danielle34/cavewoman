#!/bin/bash
# Run Claude Haiku 4.5 on all 5 datasets × 2 conditions sequentially.
...
echo "[claude-haiku-4-5] ANTHROPIC_API_KEY loaded (length: ${#ANTHROPIC_API_KEY})"
...
echo "===================================================================="
echo "[claude-haiku-4-5] START $(date -Iseconds) on $(hostname)"
...
for DATASET in "${DATASETS[@]}"; do
    for CONDITION in "${CONDITIONS[@]}"; do
        ...
        LOG="$LOGS_DIR/haiku_${DATASET}_${CONDITION}.log"

        echo
        echo "----------------------------------------------------------------"
        echo "[claude-haiku-4-5] $(date -Iseconds)  ${DATASET} / ${CONDITION}"
        echo "----------------------------------------------------------------"
...
echo
echo "===================================================================="
echo "[claude-haiku-4-5] END $(date -Iseconds)"
echo "===================================================================="
