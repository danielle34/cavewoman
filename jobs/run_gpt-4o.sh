#!/bin/bash
# Run GPT-4o on all 5 datasets × 2 conditions sequentially.
...
echo "[gpt-4o] OPENAI_API_KEY loaded (length: ${#OPENAI_API_KEY})"
...
echo "===================================================================="
echo "[gpt-4o] START $(date -Iseconds) on $(hostname)"
...
for DATASET in "${DATASETS[@]}"; do
    for CONDITION in "${CONDITIONS[@]}"; do
        ...
        LOG="$LOGS_DIR/gpt4o_${DATASET}_${CONDITION}.log"

        echo
        echo "----------------------------------------------------------------"
        echo "[gpt-4o] $(date -Iseconds)  ${DATASET} / ${CONDITION}"
        echo "----------------------------------------------------------------"
